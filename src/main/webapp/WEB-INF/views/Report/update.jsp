...
<br/><br/><br/>
	<article>
		<div class="container" role="main">
			...
			<hr>
			<br/>
		<form name='input' id="form" method='POST' action="update.do">
			
			<div class="bg-white rounded shadow-sm"></div>			
				<div class="mb-3">
				<h4>작성자</h4>
				<input type="text" name="repid" value="${report.repid}" style="border: 1px solid #48BAE4; height:auto; width:20%;" class="form-control" readonly><div class="board_title"></div>
				<div class="board_info_box"></div>					
				<br/>
				  <br/>
				    <br/>
				<h4>이미지 들어올자리</h4>				
				...
				<!--  <div class="mb-3">
				<h4>내용</h4>
				<textarea type="text" value="hekio" rows="5"   class="form-control" value="${report.content}" readonly></textarea>
				<div class="board_info_box"></div>-->
				
				 <div class="mb-3">
					<label form="content">내용</label>
					<input class="form-control" rows="5" name="content" id="content" value="${report.content}">
				</div>				
				 <div>
				  <br/>
				    <br/>
				<input type="submit" class="btn btn-primary float-center" style="MARGIN-RIGHT: 11.5%;  MARGIN-TOP: -3%;" value="수정">
