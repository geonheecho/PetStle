...
<body>
<form action="j_t" method="post" id="form1">
<div id="d1">
 ...
 <div id="accordion">
   ...
   <h3><a href="#"><font size="2">petsle약관동의  이용약관 동의(필수)</font><input type="checkbox" name="c1" id="c1"/></a></h3>
   <td><textarea readonly="readonly" rows="5" cols="104.5">
제 1 조 (목적)
...
⑦"게시물"이라 함은 "회원"이 "서비스"를 이용함에 있어 "서비스상"에 게시한 부호ㆍ문자ㆍ음성ㆍ음향ㆍ화상ㆍ동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다. 
   ...
   <div>
     <textarea readonly="readonly" rows="5" cols="104.5">
